...
var EntryCard = (0, import_react4.memo)(function EntryCard2({ entry, on, onToggle }) {
  return (0, import_react3.createElement)(
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)("div", { style: { fontWeight: 600, fontSize: 13, color: "var(--ml-ink)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, entry.comment || entry.key.join(", ") || "\uFF08\u65E0\u6807\u9898\uFF09"),
...
function WorldbookSettingsDialog({ workspaces, onClose, variant = "dialog" }) {
  ...
  function selectAllEntries() {
    patch({ devEntryIds: Array.from(/* @__PURE__ */ new Set([...devEntries, ...filteredEntries.map((e) => e.id)])) });
  }
    ...
    devBookId ? (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)(
          ...
          (0, import_react3.createElement)("input", { type: "text", className: "wb-input wb-entry-search", placeholder: "\u641C\u7D22\u6761\u76EE\u2026", value: entrySearch, style: { minHeight: 36 }, onChange: (e) => setEntrySearch(e.target.value) }),
        ...
        (0, import_react3.createElement)(
          "div",
          { className: "wb-entry-pages wb-entry-pages-toolbar" },
      ...
      (0, import_react3.createElement)("div", { className: "wb-entry-grid", style: { display: "grid", gap: 8, overflowY: "auto" } }, filteredEntries.length === 0 ? (0, import_react3.createElement)("div", { className: "wb-hint" }, "\u8BE5\u4E16\u754C\u4E66\u8FD8\u6CA1\u6709\u6761\u76EE\u3002") : pageEntries.map((e) => (0, import_react3.createElement)(EntryCard, { key: e.id, entry: e, on: devEntries.includes(e.id), onToggle: toggleDevEntry })))
    ) : null
  ...
  const renderBody = () => (0, import_react3.createElement)(
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)(
          "section",
          { className: "wb-settings-section wb-settings-developer" },
          (0, import_react3.createElement)("div", { className: "wb-settings-section-head wb-settings-section-toggle", role: "button", tabIndex: 0, "aria-expanded": devExpanded, onClick: () => setDevExpanded((value) => !value), onKeyDown: (e) => {
            if (e.key === "Enter" || e.key === " ") setDevExpanded((value) => !value);
          } }, (0, import_react3.createElement)("span", { className: "wb-settings-section-icon" }, "\u2726"), (0, import_react3.createElement)("div", null, (0, import_react3.createElement)("strong", null, "\u5F00\u53D1\u6A21\u5F0F"), (0, import_react3.createElement)("span", null, "\u4E3A AI \u63D0\u4F9B\u53D7\u63A7\u7684\u4E16\u754C\u4E66\u7F16\u8F91\u80FD\u529B")), (0, import_react3.createElement)("span", { className: "wb-settings-chevron" + (devExpanded ? " is-open" : "") }, "\u2304")),
          devExpanded ? (0, import_react3.createElement)(
            "div",
            null,
            (0, import_react3.createElement)("div", { className: "wb-setting-row" }, (0, import_react3.createElement)("div", null, (0, import_react3.createElement)("div", { className: "wb-name" }, "\u5F00\u53D1\u6A21\u5F0F"), (0, import_react3.createElement)("div", { className: "wb-hint" }, "\u4EC5\u5728\u9700\u8981 AI \u7F16\u8F91\u4E16\u754C\u4E66\u65F6\u5F00\u542F")), (0, import_react3.createElement)("div", { className: "wb-switch" + (devModeOn ? "" : " off"), onClick: () => patch({ devMode: !devModeOn }) })),
            devModeOn ? (0, import_react3.createElement)(
              "div",
              { className: "wb-dev-controls" },
              (0, import_react3.createElement)("div", { className: "wb-setting-row" }, (0, import_react3.createElement)("div", null, (0, import_react3.createElement)("div", { className: "wb-name" }, "\u60AC\u6D6E\u7A97")), (0, import_react3.createElement)("div", { className: "wb-switch" + (settings.devFloating ? "" : " off"), onClick: () => patch({ devFloating: !settings.devFloating }) })),
              permBlock(),
