...
function WorldbookSettingsDialog({ workspaces, onClose, variant = "dialog" }) {
  ...
  (0, import_react4.useEffect)(() => {
    api("/settings").then(setLoaded).catch(() => setLoaded({ enabled: "true", workspaceMode: "all", workspaceIds: "[]", theme: "dsh", injectMode: "per-turn", devMode: "false", devAction: "create", devBookId: "", devEntryIds: "[]", devPerms: '["create","delete","update","read"]', compatEnabled: "false", exposeOperations: "false", agentRpCompat: "false", agentRpDebug: "false" }));
  }, []);
  (0, import_react4.useEffect)(() => {
  ...
  const renderBody = () => (0, import_react3.createElement)(
    ...
    // 兼容模式总开关
    (0, import_react3.createElement)("div", { className: "wb-field-label", style: { marginTop: 14 } }, "\u517C\u5BB9\u6A21\u5F0F"),
    (0, import_react3.createElement)(
      "div",
      { className: "wb-row", style: { cursor: "default", background: "var(--ml-bg-surface)" } },
      (0, import_react3.createElement)(
        "div",
        { style: { flex: 1 } },
        (0, import_react3.createElement)("div", { className: "wb-name" }, "\u517C\u5BB9\u6A21\u5F0F"),
        (0, import_react3.createElement)("div", { className: "wb-meta" }, "\u603B\u5F00\u5173\u3002\u5173\u95ED\u540E\u6240\u6709\u517C\u5BB9\u6A21\u5F0F\u8BBE\u7F6E\u5931\u6548\uFF0C\u672C\u63D2\u4EF6\u53EA\u5904\u7406\u5168\u5C40\u4E16\u754C\u4E66\uFF1B\u5F00\u542F\u540E\u624D\u8BFB\u53D6\u5BBF\u4E3B\u89D2\u8272\u5361\u7ED1\u5B9A\u4E16\u754C\u4E66\u5E76\u63A5\u7BA1\u5BBF\u4E3B\u6CE8\u5165\u3002")
      ),
      (0, import_react3.createElement)("div", { className: "wb-switch" + (compatOn ? "" : " off"), onClick: () => patch({ compatEnabled: String(!compatOn) }) })
    ),
    (0, import_react3.createElement)(
      "div",
      { className: "wb-row", style: { cursor: "default", background: "var(--ml-bg-surface)" } },
      (0, import_react3.createElement)(
        "div",
        { style: { flex: 1 } },
        (0, import_react3.createElement)("div", { className: "wb-name" }, "\u5411\u5BBF\u4E3B\u66B4\u9732\u4E16\u754C\u4E66\u64CD\u4F5C\u63A5\u53E3"),
        (0, import_react3.createElement)("div", { className: "wb-meta" }, "\u5F00\u542F\u540E\u63D0\u4F9B worldbook.operations \u670D\u52A1\uFF0C\u5BBF\u4E3B\u7684\u811A\u672C / AI \u80FD\u529B\u53EF\u901A\u8FC7\u5B83\u5BF9\u672C\u63D2\u4EF6\u7684\u4E16\u754C\u4E66\u8FDB\u884C\u8BFB\u5199\uFF08\u589E\u5220\u6539\u3001\u542F\u505C\uFF09\u3002")
      ),
      (0, import_react3.createElement)("div", { className: "wb-switch" + (exposeOpsOn ? "" : " off"), style: !compatOn ? { opacity: 0.45, pointerEvents: "none" } : void 0, onClick: () => patch({ exposeOperations: String(!exposeOpsOn) }) })
    ),
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)(
        "div",
        { style: { flex: 1 } },
        (0, import_react3.createElement)("div", { className: "wb-name" }, "\u517C\u5BB9 dsh-agent-rp"),
        (0, import_react3.createElement)("div", { className: "wb-meta" }, "\u9002\u914D dsh-agent-rp \u4F1A\u8BDD\uFF1A\u62E6\u622A\u5176\u4E16\u754C\u4E66\u5BFC\u5165\u843D\u672C\u5E93\u3001\u5F71\u5B50\u5176 /rp-world-info \u547D\u4EE4\u3001\u8BFB\u5176\u4F1A\u8BDD\u4E8B\u4EF6\uFF08\u89D2\u8272\u5361\u4E66/\u811A\u672C\u4E66\uFF09\u7ECF worldbook.source/context \u6CE8\u5165\u3002\u9700\u540C\u65F6\u5F00\u542F\u300C\u63A5\u7BA1\u5BBF\u4E3B\u7684\u4E16\u754C\u4E66\u300D\u3002")
      ),
      (0, import_react3.createElement)("div", { className: "wb-switch" + (agentRpOn ? "" : " off"), style: !compatOn ? { opacity: 0.45, pointerEvents: "none" } : void 0, onClick: () => patch({ agentRpCompat: String(!agentRpOn) }) })
    ),
    // agent-rp 兼容调试
    (0, import_react3.createElement)(
      "div",
      ...
      (0, import_react3.createElement)(
        "div",
        { style: { flex: 1 } },
        (0, import_react3.createElement)("div", { className: "wb-name" }, "agent-rp \u517C\u5BB9\u8C03\u8BD5\u65E5\u5FD7"),
        (0, import_react3.createElement)("div", { className: "wb-meta" }, "\u5F00\u542F\u540E\u63A7\u5236\u53F0\u5B9E\u65F6\u6253\u5370\u6BCF\u4E2A agent-rp \u4F1A\u8BDD\u7684\u89D2\u8272 / \u7ED1\u5B9A\u4E66 / source \u4E66\uFF08\u6BCF\u4F1A\u8BDD\u6BCF 2 \u79D2\u4E00\u6761\uFF09\u3002\u53E6\u53EF\u8BBF\u95EE /api/worldbook/compat/agent-rp \u770B\u5168\u91CF\u4F1A\u8BDD\u5FEB\u7167\u3002")
      ),
      (0, import_react3.createElement)("div", { className: "wb-switch" + (agentRpDebugOn ? "" : " off"), style: !compatOn ? { opacity: 0.45, pointerEvents: "none" } : void 0, onClick: () => patch({ agentRpDebug: String(!agentRpDebugOn) }) })
    ),
    // 开发世界书模式
...
function WorldbooksPage({ workspaces }) {
  ...
  const [characterBooks, , reloadCharacterBooks] = useData(() => api("/character-books"));
