...
function WorldbookSettingsDialog({ workspaces, onClose, variant = "dialog", developerOnly = false, hideDevToggles = false, onDeveloperPointerDown }) {
  ...
  ) : devModeOn ? (0, import_react3.createElement)("div", { className: "wb-hint" }, "\u65B0\u5EFA\u6A21\u5F0F") : null;
  function permBlock() {
    const PERMS = [
  ...
  const developerSection = (forceExpanded = false, flat = false) => (0, import_react3.createElement)(
    ...
    (0, import_react3.createElement)("div", { className: "wb-settings-section-head" + (forceExpanded ? "" : " wb-settings-section-toggle"), role: forceExpanded ? void 0 : "button", tabIndex: forceExpanded ? void 0 : 0, "aria-expanded": forceExpanded || devExpanded, onPointerDown: forceExpanded ? onDeveloperPointerDown : void 0, onClick: forceExpanded ? void 0 : () => setDevExpanded((value) => !value), onKeyDown: forceExpanded ? void 0 : (e) => {
    ...
    forceExpanded || devExpanded ? (0, import_react3.createElement)(
      ...
      devModeOn ? (0, import_react3.createElement)(
        ...
        permBlock(),
        (0, import_react3.createElement)("div", { className: "wb-setting-field" }, (0, import_react3.createElement)("div", { className: "wb-field-label" }, "\u7F16\u8F91\u65B9\u5F0F"), (0, import_react3.createElement)("div", { className: "wb-segmented" }, (0, import_react3.createElement)("button", { className: "wb-btn" + (devAction === "create" ? " active" : ""), onClick: () => patch({ devAction: "create" }) }, "\u65B0\u5EFA"), (0, import_react3.createElement)("button", { className: "wb-btn" + (devAction === "edit" ? " active" : ""), onClick: () => patch({ devAction: "edit" }) }, "\u7F16\u8F91")))
      ) : null,
      devTargetView
    ) : null
  );
...
function WorldbookDevFloating({ workspaces, sessions }) {
  ...
  return (0, import_react7.createElement)(
    ...
    }, (0, import_react7.createElement)("span", { className: "wb-dev-floating-glyph" }, "\u2726"), (0, import_react7.createElement)("span", { className: "wb-dev-floating-label" }, "\u4E16\u754C\u4E66")),
    open ? (0, import_react7.createElement)(
      ...
      (0, import_react7.createElement)(
        ...
        (0, import_react7.createElement)("button", { className: "wb-btn wb-dev-floating-close", onPointerDown: (e) => e.stopPropagation(), onClick: () => setOpen(false), title: "\u5173\u95ED" }, "\xD7"),
        (0, import_react7.createElement)("div", { className: "wb-dev-floating-window-body" }, (0, import_react7.createElement)(WorldbookSettingsDialog, { workspaces, variant: "developer", developerOnly: true, hideDevToggles: true, onDeveloperPointerDown: (event) => onWindowPointerDown(event) }))
      )
    ) : null
  );
}
