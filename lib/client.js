    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)(
          "div",
          { className: "wb-actions", style: { marginTop: 16 } },
          (0, import_react3.createElement)("button", { className: "wb-btn", onClick: () => onClose?.() }, "\u5173\u95ED")
        )
      )
    )
  );
    ...
    (0, import_react5.createElement)(
      ...
      (0, import_react5.createElement)(
        ...
        (0, import_react5.createElement)(
          ...
          "\u5BFC\u5165",
          (0, import_react5.createElement)("input", { type: "file", accept: ".json,application/json", style: { display: "none" }, onChange: (e) => onWorldbookImport(e, () => {
            setMsg("\u5BFC\u5165\u6210\u529F \u2713");
            refresh();
          }, (id) => setSelectedId(id)) })
        )
      ...
      (0, import_react5.createElement)(
        ...
        bookList.length === 0 ? (0, import_react5.createElement)("div", { className: "wb-hint" }, "\u8FD8\u6CA1\u6709\u4E16\u754C\u4E66\uFF0C\u70B9\u300C\uFF0B \u65B0\u5EFA\u4E16\u754C\u4E66\u300D\u521B\u5EFA\u4E00\u672C\uFF0C\u6216\u7528\u300C\u5BFC\u5165\u300D\u8BFB\u53D6 ST \u4E16\u754C\u4E66 JSON\u3002") : bookList.map(
...
function NewWorldbookModal(props) {
  ...
  return (0, import_react5.createElement)(
    "div",
    { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.4)", zIndex: 1e3, display: "flex", alignItems: "center", justifyContent: "center" } },
    (0, import_react5.createElement)(
      "div",
...
function onWorldbookImport(e, onDone, onSelect) {
  ...
  reader.onload = async () => {
    try {
      ...
      const jsonName = typeof parsed.name === "string" ? parsed.name.trim() : "";
      ...
      await showAlert({ title: "\u5BFC\u5165\u5931\u8D25", message: err.message });
    }
  };
  ...
  return (0, import_react5.createElement)(
    ...
    (0, import_react5.createElement)(
      ...
      (0, import_react5.createElement)(
        ...
        entries === null ? (0, import_react5.createElement)("div", { className: "wb-hint" }, "\u52A0\u8F7D\u4E2D\u2026") : !entries || entries.length === 0 ? (0, import_react5.createElement)("div", { className: "wb-hint" }, "\u6682\u65E0\u6761\u76EE\uFF0C\u70B9\u300C\uFF0B \u65B0\u589E\u6761\u76EE\u300D\u521B\u5EFA\uFF0C\u6216\u5BF9\u4E66\u672C\u300C\u5BFC\u5165\u300DST JSON\u3002") : entries.map(
...
function EntryEditorModal(props) {
  ...
  return (0, import_react5.createElement)(
    "div",
    { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.5)", zIndex: 1e3, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" } },
    (0, import_react5.createElement)(
      "div",
...
var theme_default = `/* dsh-worldbook \u72EC\u7ACB\u4E3B\u9898\u3002
 * \u6240\u6709\u989C\u8272\u90FD\u7ECF\u7531 --ml-* \u53D8\u91CF\u8DEF\u7531\uFF1B\`.dsh-theme\`\uFF08\u8DDF\u968F dsh\uFF09\u628A --ml-* \u6620\u5C04\u5230 dsh \u7684
 * --dsw-alias-* \u8BED\u4E49 token\uFF08\u5728 body \u4E0A\u6309\u660E\u6697\u4E3B\u9898\u89E3\u6790\uFF09\uFF0C\u5173\u95ED\u65F6\u56DE\u843D\u5230\u7C89\u8272\u9ED8\u8BA4\u503C\u3002 */
.dsh-worldbook-root {
  /* \u7C89\u8272\u53D8\u91CF\uFF08\u6D45\u8272\u9ED8\u8BA4\uFF09 */
  --ml-pink-0: #fff0f5;
  --ml-pink-1: #ffe4ec;
 ...
 * dsh \u5728 body / body[data-ds-dark-theme] \u4E0A\u5B9A\u4E49\u8FD9\u4E9B token\uFF0C\u660E\u6697\u4E3B\u9898\u81EA\u52A8\u8DDF\u968F\u3002
 * \u5173\u95ED\u65F6\uFF08\u65E0 .dsh-theme\uFF09\u56DE\u843D\u5230\u4E0A\u65B9\u9ED8\u8BA4\u7C89\u8272\u53D8\u91CF\u3002 */
.dsh-worldbook-root.dsh-theme {
  ...
  --ml-pink-6: var(--dsw-alias-state-business-primary);
  --ml-pink-7: var(--dsw-static-deepseek-600);
