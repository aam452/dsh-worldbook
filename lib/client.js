...
function WorldbookSettingsDialog({ workspaces, onClose, variant = "dialog" }) {
  ...
  const renderBody = () => (0, import_react3.createElement)(
    ...
    // 兼容宿主插件（世界书接管协议）
    (0, import_react3.createElement)("div", { className: "wb-field-label", style: { marginTop: 14 } }, "\u517C\u5BB9\u5BBF\u4E3B\u63D2\u4EF6"),
    (0, import_react3.createElement)(
      "div",
      { className: "wb-row", style: { cursor: "default", background: "var(--ml-bg-surface)" } },
      (0, import_react3.createElement)(
        "div",
        { style: { flex: 1 } },
        (0, import_react3.createElement)("div", { className: "wb-name" }, "\u63A5\u7BA1\u5BBF\u4E3B\u7684\u4E16\u754C\u4E66"),
        (0, import_react3.createElement)("div", { className: "wb-meta" }, "\u5F00\u542F\u540E\u672C\u63D2\u4EF6\u8FDB\u5165\u300C\u5168\u5C40 + \u89D2\u8272\u5361\u7ED1\u5B9A\u300D\u53CC\u6A21\u5F0F\uFF1A\u63A5\u7BA1\u5BBF\u4E3B\u63D2\u4EF6\uFF08\u63D0\u4F9B\u89D2\u8272\u5361/\u4F1A\u8BDD\u7684\u63D2\u4EF6\uFF09\u7684\u4E16\u754C\u4E66\uFF0C\u5176\u6CE8\u5165\u8BA9\u4F4D\uFF1B\u5173\u95ED\u65F6\u4EC5\u5168\u5C40\u4E16\u754C\u4E66\u751F\u6548\u3002")
      ),
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)("div", { className: "wb-switch" + (exposeOpsOn ? "" : " off"), onClick: () => patch({ exposeOperations: String(!exposeOpsOn) }) })
    ),
    // 兼容 dsh-agent-rp
    (0, import_react3.createElement)(
      "div",
      ...
      (0, import_react3.createElement)("div", { className: "wb-switch" + (agentRpOn ? "" : " off"), onClick: () => patch({ agentRpCompat: String(!agentRpOn) }) })
    ),
    // agent-rp 兼容调试
    (0, import_react3.createElement)(
      "div",
      ...
      (0, import_react3.createElement)("div", { className: "wb-switch" + (agentRpDebugOn ? "" : " off"), onClick: () => patch({ agentRpDebug: String(!agentRpDebugOn) }) })
    ),
    // 开发世界书模式
