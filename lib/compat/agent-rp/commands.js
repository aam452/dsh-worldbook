...
function entriesInStOrder(bookId) {
    ...
    const tryRegister = () => {
        ...
        try {
            ...
            if (!commands)
                return;
            registered = true;
            disposeRegistration = commands.register(makeCommand('rp-world-info', executeConfiguration, 'manage this roleplay Session world info (dsh-worldbook)')) ?? null;
